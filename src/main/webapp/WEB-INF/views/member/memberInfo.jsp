	      	...
	      	<h4 class="text-center">회원정보 수정</h4>
		      	<form action="memberUpdate.do" method="post" name="joinForm">       
		      	  ...
		      	  <div class="mt-2 mb-2">
			         ...
			         <input type="text" class="form-control" id="no" name="no" value="${dto.memberNum}" readonly/>
			      </div>		      			      	      			      		       
			      <div class="mb-2">
			      ...
			      <div class="mb-2">
			         ...
			         <input type="password" class="form-control" id="pw" name="pw" value="${dto.memberPw}" readonly/>
			      </div>			      
			      <div class="mb-2">
			         <lable for="pwConfirm">비밀번호 확인 : 수정불가(비밀번호 패널에서 수정하세요)</lable>
			        
			         <input type="password" class="form-control" id="pwConfirm" name="pwConfirm" value="${dto.memberPw}" readonly/>
			      </div>
...
<%-- 			      <div class="mb-2">
			      ...
			      <div class="text-center mt-3"><br>
			         <input type="button" class="btn btn-sm" value="회원정보 수정" onclick="inputChk()"/>
			         <input type="reset" class="btn btn-sm" value="취소"/>
			         <!-- <a href="memberList.do" class="btn btn-sm">회원 리스트</a> -->
			         &nbsp;&nbsp;<a href="memberDelete.do?no=${dto.memberNum}" class="btn btn-sm">회원 탈퇴</a>
			      </div>
		      </form>
	    ...
	    <div id="menu2" class="container tab-pane fade ${find == 'pwch' ? 'show active':''}"><br>
			<h4 class="text-center">비밀번호 변경</h4><br>
				...
				<input  class="form-control mb-2" type="text" value="${sessionScope.loginDTO.memberPw}"/>
			...
			<div class="text-center"><br>
				<button type="button" id="pwChangeBtn" class="btn btn-sm">비밀번호 변경</button>
				<input type="reset" id="pwChangeReset" class="btn btn-sm" value="취소"/>	<!-- form 태그 안에 없어서 안됌, id="pwChangeReset" 자바스크립트로 진행 -->
